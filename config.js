...
global.sig = 'https://instagram.com/jidan_7011/' // ig
global.sgh = '-' // github
...
/*============== PAYMENT ==============*/
global.pdana = '085728644127' //dana
global.povo = '-' //ovo
global.pgopay = '-' //gopay
...
/*============== NOMOR ==============*/
global.nomorbot = '6285158447011'
global.nomorown = '6285728644127'
global.namebot = 'DanzzBotz'
global.nameown = 'Jidan'
...
/*============== WATERMARK ==============*/
global.wm = '                「 DanzzBoTz 」' //Main Watermark
global.wm2 = '「 Danzz-BOT  あ」'
global.wm3 = '⫹⫺ Danzz-BOT '
global.botdate = `⫹⫺ TANGGAL: ${week} ${date}\n⫹⫺ 𝗧𝗶𝗺𝗲: ${wktuwib}`
global.bottime = `W A K T U : ${wktuwib}`
global.titlebot = `⫹⫺ WhatsApp Bot | By Jidan`
global.packname = 'DanzzBotz WhatsApp'
global.author = '                「 Danzz-BOT  あ」'
...
/*============== STICKER WM ==============*/
global.stickpack = 'Danzz-BOT'
global.stickauth = `By @jidan_7011`
